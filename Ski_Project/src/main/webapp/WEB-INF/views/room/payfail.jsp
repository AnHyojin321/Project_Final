...
<body>
    ...
    <!-- 중앙에 이미지 배치 -->
    <img src="${pageContext.request.contextPath}/resources/images/fail.jpg" class="center-image" alt="결제 완료 이미지">
    
     <!-- 예약 완료 문구 -->
    <div class="sorry-you-message">
    	<h1>결제 실패</h1>
        <p>죄송합니다. 다시 시도해주세요.</p>
    </div>
    ...
    <div class="button-group">
        ...
        <button class="btn">
            <span onclick="location.href='${pageContext.request.contextPath}/list.ro'">객실예약 바로가기</span>
        </button>
    </div>
