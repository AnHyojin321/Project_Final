            ...
            <div>
                <div style="display:flex; gap:48%;">
                    ...
                    <div style="flex:right; margin:auto;">
	                    <a href="dayPass.li">
	                    	<input type="button" value="일일권 구매하기"/>
	                    </a>                    
                    </div>
                </div>  
                <br>
				...
				<script>
					...
					document.getElementById('addItem').addEventListener('click', () => {
					    ...
					    newRow.innerHTML = `
					        <td width="17%">\${liftType}</td>
					        <td width="12%">\${liftAge}</td>
					        <td width="30%">
					        	<div id="quantityTd">
					        ...
					        <td class="price" width="33%" style="margin-left:10%; font-size: 19px;">\${price.toLocaleString()}원</td>
					        <td width="8%"><button type="button" id="deleteBtn" onclick="deleteItem(event)">x</button></td>
					    `;
